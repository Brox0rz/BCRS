...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'admin', component: AdminComponent, title: 'BCRS: Admin', canActivate: [authGuard, RoleGuard] }, // Added RoleGuard
      ...
      { path: 'user-management', component: UserManagementComponent, title: 'BCRS: User Management', canActivate: [authGuard, RoleGuard] }, // Added RoleGuard
